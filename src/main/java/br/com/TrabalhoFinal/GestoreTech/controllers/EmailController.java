    ...
    public String enviarEmailHtml(@PathVariable String destinatario) {
        ...
        try {
            ...
            String html = ""
                    ...
                    + "\n"
                    + "<div style='text-align: center; margin-bottom: 24px;'>\n"
                    + "<a href='http://localhost:8000/html/redefinirSenha.html?email=" + destinatario + "' target='_blank' style='display: inline-block; background-color: #4f46e5; color: #ffffff; font-size: 15px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 10px; box-shadow: 0 4px 10px rgba(79, 70, 229, 0.3);'>\n"
                    ...
                    + "<a href='http://localhost:8000/html/redefinirSenha.html?email=" + destinatario + "' target='_blank' style='color: #4f46e5; text-decoration: underline; word-break: break-all;'>\n"
                    + "Clique AQUI\n"
                    + "</a>\n"
                    + "</p>\n"
                    + "</div>\n"
    ...
    public String enviarEmailConta(@PathVariable String destinatario, @PathVariable String senhaCpf) {
        ...
        try {
            ...
            String html = ""
                    ...
                    + "\n"
                    + "<p style='color: #6b7280; font-size: 15px; line-height: 1.6; margin-top: 0; margin-bottom: 24px; text-align: center;'>\n"
                    + "Olá! Sua conta de login para o sistema <strong>Gestor&amp;Tech</strong> foi criada com sucesso. Utilize as credenciais abaixo para realizar o seu primeiro acesso.\n" // Corrigido aqui
                    + "</p>\n"
                    + "\n"
                    + "\n"
                    ...
                    + "\n"
                    + "<div style='text-align: center; margin-bottom: 24px;'>\n"
                    + "<a href='http://localhost:8000/login.html' target='_blank' style='display: inline-block; background-color: #4f46e5; color: #ffffff; font-size: 15px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 10px; box-shadow: 0 4px 10px rgba(79, 70, 229, 0.3);'>\n"
                    + "Acessar o Sistema\n"
                    + "</a>\n"
                    + "</div>\n"
                    + "\n"
                    + "<div style='background-color: #fbfbfb; border-left: 4px solid #f0b429; padding: 12px 16px; border-radius: 0 8px 8px 0; margin-bottom: 24px; border-top: 1px solid #f3f4f6; border-right: 1px solid #f3f4f6; border-bottom: 1px solid #f3f4f6;'>\n"
                    + "<p style='margin: 0; font-size: 13px; color: #627d98; line-height: 1.5;'>\n"
                    + "<strong>Importante:</strong> Por motivos de segurança, você deverá alterar esta senha provisória assim que realizar o seu primeiro login.\n"
                    + "</p>\n"
                    + "</div>\n"
                    + "\n"
                    + "<hr style='border: 0; border-top: 1px solid #f3f4f6; margin-bottom: 20px;'>\n"
