const API_LISTAR_TECNICO = 'http://192.168.10.22/usuarios/listarTecnicos';
const API_LISTAR_TECNICO_POR_NOME = 'http://192.168.10.22/usuarios/listarTecnicosNome';
const API_SALVAR_TECNICO = 'http://192.168.10.22/usuarios/salvarTecnico';
